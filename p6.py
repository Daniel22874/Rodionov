...
info["фио"] = "Родионов Данил Владимирович"
info["дата рождения"] = "14.03.2006"
info["место рождения"] = "Липецк"
# Напечатать словарь
print(info)
# Создать ключ "хобби" со значением = список из строк -
# наименований хобби (например "плавание" и т.д.)
info["хобби"] = ["плавание", "лыжи", "футбол"]
...
info["животные"] = ["кот Матроскин", "пёс Шарик", "медведь Миша"]
...
info["ЕГЭ"] = {"русский язык": 91, "математика": 78, "ИНФОРМАТИКА": 80}
...
vowel = "УЕЫАОЭЯИЮ"
starts_with_vowel = True if name[0] in vowel else False
print("* мое имя начинается на гласную букву:", starts_with_vowel)
# Выделить месяц из info["дата_рождения"]
month = info["дата рождения"].split(".")[1]
winter_summer = ["12", "01", "02", "06", "07", "08"]
# Родился зимой или летом? (True/False)
born_in_winter_or_summer = True if month in winter_summer else False
